	...
	<a-card :bordered="false" class="header-solid h-full" :bodyStyle="{padding: 0,}">
		<template #title>
			<a-row type="flex" align="middle">
				<a-col :span="24" :md="15" style="display: flex; align-items: center;">
					<a-radio-group v-model="projectHeaderBtns" size="small">
						<a-radio-button value="Automation" style="margin-right:50px;">Automation</a-radio-button>
						<a-radio-button value="Campaigns" style="margin-right:50px;">Campaigns</a-radio-button>
						<a-radio-button value="Segments">Segments</a-radio-button>
					</a-radio-group>
				</a-col>
			</a-row>
		</template>
